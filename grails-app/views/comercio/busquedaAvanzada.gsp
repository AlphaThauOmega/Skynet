                    ...
                    <div id="search-table">
                        <g:form  controller="comercio" action="busquedaAvanzada" params="[busqueda:true]">
                            ...
                            <table>
                                ...
                                <tr><td class="table-inf">Recomendada </td><td colspan="3" class="table-input"><input type="text" name="recomendada" maxlength="100" placeholder="Especialidad" value="" id="recomendada" /></td></tr>
